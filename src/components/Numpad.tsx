...
export function Numpad({
  ...
  return (
    <div className="flex flex-col gap-2 select-none">
      ...
      {onMinus && (
        <button type="button" aria-label="Toggle sign" onClick={onMinus}
          className="h-14 rounded-xl bg-slate-200 text-2xl font-semibold text-slate-700 active:scale-95 dark:bg-slate-700 dark:text-slate-200">
          ±
        </button>
      )}
    </div>
